...
class ProductForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'description': forms.Textarea(attrs={'class': INPUT_CLASSES, 'rows': 3}),
            'category': forms.Select(attrs={'class': INPUT_CLASSES, 'data-control': 'select2', 'data-placeholder': 'Sélectionner une catégorie'}),
            'supplier': forms.Select(attrs={'class': INPUT_CLASSES, 'data-control': 'select2', 'data-placeholder': 'Sélectionner un fournisseur'}),
